...
<section id="hero" class="hero section dark-background">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <p>I'm <span class="typed" data-typed-items="{{$experts ?: ($portfolio->job_title ?: 'Developer')}}">{{$portfolio->job_title ?: 'Developer'}}</span><span
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4 justify-content-center">
            <div class="col-lg-4 col-md-5">
                ...
                <img src="{{asset('storage/'. $portfolio->picture)}}" class="img-fluid about-profile-picture" alt="">
                @endif
            </div>
            <div class="col-lg-8 content">
                <h2>{{$portfolio->job_title ?: 'Full Stack Web Developer'}}.</h2>
                    ...
                    <div class="col-lg-6">
                        <ul>
                            ...
                            <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                <span><a href="{{$portfolio->web}}" target="_blank" rel="noopener">{{$portfolio->web}}</a></span>
                            </li>
                            @endif
                            @if($portfolio->phone)
                    ...
                    <div class="col-lg-6">
                        <ul>
                            ...
                            <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong>
                                <span>{{$portfolio->degree ?: 'Master'}}</span>
                            </li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                                <span>{{$portfolio->email}}</span>
                            </li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong>
                                <span>{{$portfolio->freelance_status ?: 'Available'}}</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-{{$project->project_category_id}}">
                    <div class="portfolio-content h-100">
                        <img src="{{asset('storage/'. $project->projectImage?->image??'')}}" class="img-fluid portfolio-project-image" alt="{{$project->short_name}}">
...
<section id="contact" class="contact section light-background">
    ...
    <div class="container section-title" data-aos="fade-up">
        <h2>Contact</h2>
        <p>Have a project, collaboration, or question? Send a message and I will get back to you.</p>
    </div><!-- End Section Title -->
